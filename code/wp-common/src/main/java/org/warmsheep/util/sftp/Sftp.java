package org.warmsheep.util.sftp;
...
import org.warmsheep.util.FileUtils;
...
//			jsch.getSession(username, host, port);
	 ...
	 * @param channel
	 * @version 1.0,2015年11月26日 下午6:07:33,Liugl,Ins
	 */
	public static void upload(String directory, InputStream uploadFile, String fileName, ChannelSftp channel) {
		try {
			creatDir(directory, channel);
			channel.cd(directory);
