...
import org.warmsheep.util.validate.ValidateUtils;
...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static final SimpleDateFormat LONG_DATE_FORMAT_TWO = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	/**
	 * 得到长日期格式字串，返回格式（yyyy-MM-dd HH:mm:ss）
	 * @return
	 */
	...
	public static String getLongDateStr(Date date) {
		return LONG_DATE_FORMAT_TWO.format(date);
	}
